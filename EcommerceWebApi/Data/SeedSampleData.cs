...
namespace EcommerceWebApi.Data
{
    public static class SeedSampleData
    {
        ...
        public static ModelBuilder SeedChatRoom(this ModelBuilder builder)
        {
        ...
        public static ModelBuilder SeedMessage(this ModelBuilder builder)
        {
            builder.Entity<Message>().HasData(
                ...
                {
                    Id = 6,
                    Content = "It's at 10 AM tomorrow.",
                    IsRead = true,
        ...
        public static ModelBuilder SeedAccountChatRoom(this ModelBuilder builder)
        {
            builder.Entity<AccountChatRoom>().HasData(new AccountChatRoom
            {
                AccountId = 2,
                ChatRoomId = 1,
            },
